---
postedAt: "2023-03-28"
thumbnail: /images/01-sample/how-to-make-beef-stew.jpeg
...
<h1 className=""> Preservation Method </h1>

Transfer the stock to a food storage container and store in the fridge. It can
be used for 2-3 days.
